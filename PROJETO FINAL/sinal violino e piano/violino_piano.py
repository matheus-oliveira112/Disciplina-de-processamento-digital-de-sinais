...
sinal_original, fs = sf.read("violino_piano.wav")
...
sf.write("violino_piano_filtrada1.wav", sinal_filtrado1, fs)
sf.write("ruido2.wav", sinal_ruido2, fs)
sf.write("violino_piano_filtrada2.wav", sinal_filtrado2, fs)